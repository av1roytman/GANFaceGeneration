...
def main():
    ...
    # Model Initialization from saved state
    ...
    for epoch in range(1 + 150, num_epochs + 150 + 1):
        for i, data in enumerate(dataloader, 0):
            ...
            if epoch % 25 == 0 and i == 0:
                ...
                torch.save(netG.state_dict(), os.path.join(model_base, f'Gen-6Layer-128x128-SAGAN-{epoch}.pth'))
                torch.save(netD.state_dict(), os.path.join(model_base, f'Dis-6Layer-128x128-SAGAN-{epoch}.pth'))
