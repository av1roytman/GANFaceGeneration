...
class Generator(nn.Module):
    def __init__(self, noise_dim, embed_dim, ff_dim, dropout):
        ...
        self.pos_enc_stage1 = PositionalEncoding(self.initial_dimension * self.initial_dimension, embed_dim)
        ...
        self.pos_enc_stage2 = PositionalEncoding(16 * 16, embed_dim)
        ...
        self.pos_enc_stage3 = PositionalEncoding(32 * 32, embed_dim)
        ...
        self.pos_enc_stage4 = PositionalEncoding(64 * 64, embed_dim)
        ...
        self.pos_enc_stage5 = PositionalEncoding(128 * 128, embed_dim)
